...
- [x] 删除设置页面：移除 settings 相关的 API 路由、组件和页面
- [x] 生成 Prisma 客户端：自动生成 Prisma 数据库操作客户端
- [x] 添加模板页面：创建新的模板管理页面
- [x] 去掉音频格式选择：删除音频格式选择UI，固定为MP3格式
- [x] 统一声音名称验证：修改声音名称验证逻辑，使其与参考文本、参考音频文件的验证方式一致，点击克隆时弹出统一的错误提示
